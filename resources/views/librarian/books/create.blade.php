<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('New Book') }}</h2>
    </x-slot>
                ...
                <div class="p-6 bg-white">
                    ...
                    <form action="{{ route('librarian.books.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" value="{{ old('title') }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm" required>
                        </div>
                        ...
                        <div class="mb-4 grid grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" name="total_quantity" value="{{ old('total_quantity', 0) }}" class="mt-1 block w-full border-gray-300 rounded-md shadow-sm">
                            </div>
                        </div>
                        ...
                        <div x-data='{
                            ...
                            selectedAuthors: @json(old('authors', [])),
                            selectedCategories: @json(old('categories', [])),
                            imagePreview: null,
                            _currentBlob: null,
                        ...
                        <div class="mb-4">
                            ...
                            <div x-show="imagePreview" x-cloak class="mt-2 mb-2">
                                <img :src="imagePreview" alt="Preview" class="max-h-48 rounded">
                            </div>

                            <!-- JS fallback preview (non-Alpine) -->
                            <div class="mt-2 mb-2">
                                <img id="js-image-preview" alt="Preview" class="max-h-48 rounded hidden">
                            </div>
                        ...
                        <script>
                        // Fallback preview in case Alpine doesn't update the view
                        (function(){
                        ...
                        <div class="flex items-center justify-end">
                            ...
                            <button class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-500">Create</button>
                        </div>
                    </form>
                </div>
            </div>
